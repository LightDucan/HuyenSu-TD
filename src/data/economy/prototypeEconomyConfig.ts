...
import { ACTIVE_HBT_EQUIPMENT_IDS } from '../equipment/definitions'
...
export const haiBaTrungGoldGachaConfig: GoldGachaConfig = {
  ...
  rewards: [
    ...
    { id: 'weapon-lv1', type: 'equipment', definitionId: ACTIVE_HBT_EQUIPMENT_IDS[0], weight: balanceV1.gacha.weights.weapon },
    { id: 'gem-lv1', type: 'equipment', definitionId: ACTIVE_HBT_EQUIPMENT_IDS[1], weight: balanceV1.gacha.weights.gem },
...
export const prototypeGoldGachaConfig = haiBaTrungGoldGachaConfig
