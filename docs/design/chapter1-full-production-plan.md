...
| `hbt-lang-bac-stage-02` | Rút Tuyến Lãng Bạc | 42 CE; pressure on the Lãng Bạc line | COMPOSITE RECONSTRUCTION | Rearguard defense and controlled retreat | Preserve the retreat route | Does not claim a strategic defeat of Mã Viện | `map-lang-bac-retreat-corridor` | Han mixed formation; no boss | 22 |
| `hbt-cam-khe-stage-03` | Phòng Tuyến Cẩm Khê | 42–43 CE; Cẩm Khê (site debated) | CORE location/event + gameplay reconstruction | Fixed-path defensive line | Hold this engagement only | No false strategic victory | `map-cam-khe-defensive-line` | Han sword, crossbow, armored; no boss | 24 |
