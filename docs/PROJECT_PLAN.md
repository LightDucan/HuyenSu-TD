...
- Branch hiện tại: `codex/p12-c02-wave-energy-auto-wave`
...
- Current Codex task: **P12-C02 — DONE, waiting Audit** — branch `codex/p12-c02-wave-energy-auto-wave`.
...
- Lần kiểm tra gần nhất: P12-C02 nối Wave start với Quân Lệnh qua shared runtime transaction; 103/103 tests, build, preview HTTP 200 và diff-check PASS.
...
| P12-C02 | Wave Energy Gate & Auto Wave | DONE — waiting Audit | Codex | Explicit waiting/running/won lifecycle, manual/auto shared spend, double-spend guard, Hero gate, real-time refresh, minimal HUD và 10-Wave regression | `codex/p12-c02-wave-energy-auto-wave` |
...
| 12 — Quân Lệnh & Auto Wave | P12 | Real-time regen, overflow, Wave cost và Auto Wave gate | IN PROGRESS — P12-C02 DONE, waiting Audit | Phase 10–11 + OD-01 | Codex | Base cap 60, 2 phút/điểm, overflow, hidden time, x1/x3 independence, auto/manual parity | `codex/p12-c02-wave-energy-auto-wave` | Clock exploit, double spend hoặc auto-loop |
