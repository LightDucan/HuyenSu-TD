...
- Current Codex task: **P12-C02 — DONE / merged / PASS** — checkpoint `meta/command-energy-auto-wave-v1`.
...
- Lần kiểm tra gần nhất: P12-C02 merged vào `main`; 103/103 tests, build, preview HTTP 200 và diff-check PASS.
