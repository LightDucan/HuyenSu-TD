...
Tài liệu này đặc tả toàn bộ thiết kế hệ thống **Meta Game, Kinh Tế & Hành Trang (Meta Economy & Inventory)** cho dự án **Huyền Sử TD**. Hệ thống này quản lý vòng lặp phát triển ngoài trận (Out-of-run), ví tiền tệ (Vàng, Kim Nguyên Bảo), tài nguyên thể lực Quân Lệnh, kho trang bị/vật phẩm, và tính năng Chiêu Mộ Gacha bằng Vàng.
...
* **Out-of-run (Meta Economy & Inventory)**: Quản lý Player Wallet (2 loại tiền tệ: Vàng, Kim Nguyên Bảo), Energy Resource (Quân Lệnh), Inventory (Vũ Khí, Ngọc, Binh Phù), Nâng cấp/Ghép đồ (Merge 3 $\rightarrow$ 1), Gacha Gold và Lực lượng Triển khai (Deployment Capacity).
...
|---|---|
| [wallet-inventory-ui.md](wallet-inventory-ui.md) | Thiết kế Thanh Header HUD (Vàng, KNB, Quân Lệnh), Bottom Bar 2 tab (Đội Hình / Hành Trang) kèm Wireframe văn bản. |
| [currencies.md](currencies.md) | Hệ thống 2 loại tiền tệ (Vàng, Kim Nguyên Bảo), nguyên tắc thu chi và quản lý ví (Wallet). |
| [command-energy.md](command-energy.md) | Cơ chế Tài nguyên Quân Lệnh (Energy Resource): Tốn 1 điểm/Wave, hồi 1 điểm/2 phút thực, base cap = 60 (LOCKED), tăng cap theo level (OPEN), xử lý Overflow. |
