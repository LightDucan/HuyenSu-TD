...
3. **Phân Định Hero Mới vs Hero Trùng (Duplicate Resolution)**:
   * **Hero Mới (Chưa sở hữu)** $\rightarrow$ Mở khóa Hero vào Deck/Bộ sưu tập (`unlocked: true`), sẵn sàng xuất trận.
   * **Hero Trùng (Đã sở hữu)** $\rightarrow$ Tự động chuyển đổi thành **Mảnh Danh Tướng** của chính Hero đó (ví dụ: quay ra Trưng Trắc trùng $\rightarrow$ nhận *Mảnh Trưng Trắc*).
4. **Phân Định Công Dụng Nguyên Liệu Nâng Cấp**:
   * **Mảnh Danh Tướng (Hero Shards)**: Sử dụng **duy nhất** cho tính năng **Nâng Sao (Star Ascension: 1★ $\rightarrow$ 6★)**.
   * **Anh Hồn (Hero Souls / Hero Essences)**: Sử dụng **duy nhất** cho tính năng **Tiến Hóa Bậc (Evolution / Ascension)** qua 4 tầng:
     ...
     *(Tầng Huyền Sử mở khóa Passive đặc quyền của Tướng)*.
5. **Ràng Buộc Kỹ Thuật & Kiến Trúc**:
   * Không tự ý chốt tỷ lệ gacha (Drop Rates), số lượt bảo hiểm (Pity Counter), hay giá quy đổi; mọi thông số được định nghĩa là **tham số cấu hình mở (OPEN)** chờ Game Design & Codex phê duyệt.
...
|---|---|
| [recruitment-system.md](recruitment-system.md) | Cơ chế Chiêu Hiền Các, tiêu hao Chiêu Hiền Lệnh, phân định Hero mới / Hero trùng, kèm Wireframe Chiêu Hiền & Kết quả. |
| [star-ascension.md](star-ascension.md) | Hệ thống Nâng Sao (1★ $\rightarrow$ 6★) bằng Mảnh Danh Tướng, quy tắc cộng chỉ số Flat Bonus, kèm Wireframe UI Sao. |
| [hero-evolution-anh-hon.md](hero-evolution-anh-hon.md) | Hệ thống Tiến Hóa 4 Bậc (Phổ Thông $\rightarrow$ Trùng Sinh $\rightarrow$ Tái Sinh $\rightarrow$ Huyền Sử) bằng Anh Hồn, mở Passive Huyền Sử, kèm Wireframe UI Anh Hồn. |
