...
- Lần kiểm tra gần nhất: GAME-C09-FIX1 — 39 test files/258 tests PASS, build/diff-check PASS; C08 timing/test isolation restored; manual partial/pending; Hero/Wu art gates pending.
